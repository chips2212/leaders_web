...
const navigation = [
  { label: 'Home', href: '/' },
  {
    ...
    href: '/sectors',
    dropdown: [
      { label: 'Humanitarian & Crisis', href: '/sectors/humanitarian-ngo', coreExpertise: true },
  ...
  },
  {
    ...
    dropdown: [
      ...
      { label: 'Mentoring Programs', href: '/services/mentoring-programs' },
      { label: 'Specialized Consulting', href: '/services/specialized-consulting' },
    ],
  },
